...
export const BREED_SLUG: Record<string, string> = {
  "Граб": "grab",
  "Платан": "platan",
  "Кипарис": "kiparis",
  "Клён ам": "klen-am",
  ...
  "Тик": "tik",
  "Такула": "takula",
  "Палисандр индийский": "palisandr-indian",
  "Ниове": "niove",
  "Тайгервуд": "tigervood",
  "Биболо": "bibolo",
  "Зирикот": "zirikot",
  "Лаура Прето": "laura-preto",
  "Бокоте": "bokote",
  "Дуб мор": "dub-mor",
  "Палисандр бразильский": "palisandr-brazil",
  "Рэд Харт": "red-hart",
  "Бакаут": "bakaut",
  "Гренадил": "grenadil",
  "Амарант": "amarant",
...
export const SLUG_TO_BREED: Record<string, string> = Object.fromEntries(
  Object.entries(BREED_SLUG).map(([breed, slug]) => [slug, breed])
);
